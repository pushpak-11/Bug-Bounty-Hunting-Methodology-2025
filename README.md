...
**Amass (Passive Mode)**
```bash
amass enum -passive -d target.com -o amass_passive_subs.txt , echo "yahoo.com" | haktrails subdomains | tee hakrails_subs.txt , findomain -t cognism.com -u findomain.txt
```
